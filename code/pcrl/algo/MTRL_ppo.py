...
from pcrl.buffer import RolloutBuffer1
from pcrl.network import StateIndependentPolicy,StateFunction
from pcrl.network.policy import StateIndependentPolicy1
...
class PPO(Algorithm):
    ...
    def step(self, env, state, t, step):
        ...
        if 1024 <= self.step_num < 2048:
            ...
            if done:
                t = 0
                next_state = env.reset2()

        if self.step_num == 2048:
            self.step_num = 0
            next_state = env.reset()
