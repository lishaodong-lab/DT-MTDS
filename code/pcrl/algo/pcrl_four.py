    ...
    def step(self, env, state, t, step):
        ...
        if self.step_num < 2000:
         ...
         if info == 0:
            ...
            self.buffer5.append(state, action1, reward, done, log_pi_1, next_state)
            self.x +=1
            ...
            self.buffer5.append(state, action2, reward2, done, log_pi_2, next_state)
            self.y +=1
            ...
            self.buffer5.append(state, action3, reward3, done, log_pi_3, next_state)
            # self.y +=1
            ...
            self.buffer5.append(state, action4, reward4, done, log_pi_4, next_state)
        ...
        if 2000 < self.step_num <= 4000:

         action, log_pi = self.explore(state)
         change = 0
         next_state, reward, done, _ = env.step(action)
         self.buffer6.append(state, action, reward, done, log_pi, next_state)
         self.buffer5.append(state, action, reward, done, log_pi, next_state)
         print(self.step_num)
        #  print(next_state)
